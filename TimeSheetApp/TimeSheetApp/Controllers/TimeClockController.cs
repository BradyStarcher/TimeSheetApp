...
namespace TimeSheetApp.Controllers
{
    public class TimeClockController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,ClockIn,OutForLunch,InFromLunch,ClockOut")] TimeClock timeClock)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,ClockIn,OutForLunch,InFromLunch,ClockOut")] TimeClock timeClock)
        {
            if (id != timeClock.ID)
            {
                return NotFound();
