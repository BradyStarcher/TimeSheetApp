...
namespace TimeSheetApp.Controllers
{
    public class PayrollController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Salary,Address")] Payroll payroll)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Salary,Address")] Payroll payroll)
        {
            if (id != payroll.ID)
            {
                return NotFound();
